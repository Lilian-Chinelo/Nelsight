  ...
  return (
    <div className="m-6">
      <div className="text-center ">
        ...
        <p className="pt-6 text-xl text-dark font-semibold w-full px-8 md:w-full">
        ...
        <div className="relative w-96 h-auto bg-primary rounded-md my-12 pt-24 pb-8 mx-auto px-4 shadow-md hover:shadow-lg transition flex flex-col items-center">
          ...
          <label className="font-bold text-gray-100 text-lg">
            John Doe (MD. Company Plc.)
          </label>
          <p className="text-center text-secondary mt-2 leading-relaxed">
            Nelsight is the best data analysis company, I wanted them to 
            help organise and gainn some helpful insight from my inventory 
            stock data, which they did and also helped me grow my business
            in all ramifications.
          </p>
          <ul className="flex flex-row gap-2 mt-4">
          <button className="text-secondary hover:text-background">
